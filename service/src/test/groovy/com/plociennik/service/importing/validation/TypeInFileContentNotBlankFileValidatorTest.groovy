...
class TypeInFileContentNotBlankFileValidatorTest extends Specification {

    def validator = new TypeInFileContentNotBlankFileValidator()

    def "should return true when file's content does not have a blank type 1"() {
        given:
            String content =
    ...
    def "should return true when file's content does not have a blank type 2"() {
        given:
            String content =
                    """UUID: 6d0379ca-0019-420e-b785-e16b094f3098
                            Title: Example title
    ...
    def "should return false when file's content does have a blank type 1"() {
        given:
            String content =
                    """UUID: 6d0379ca-0019-420e-b785-e16b094f3098
                            Title: Example title
    ...
    def "should return false when file's content does have a blank type 2"() {
        given:
            String content =
                    """UUID: 6d0379ca-0019-420e-b785-e16b094f3098
                            Title: Example title
    ...
    def "should return false when file's content does have a blank type 3"() {
        given:
            String content =
                    """UUID: 6d0379ca-0019-420e-b785-e16b094f3098
                            Title: Example title
    ...
    def "should return false when file's content does have a blank type 4"() {
        given:
            String content =
                    """UUID: 6d0379ca-0019-420e-b785-e16b094f3098
                            Title: Example title
    ...
    def "should return false when file's content does have a blank type 5"() {
        given:
            String content =
                    """UUID: 6d0379ca-0019-420e-b785-e16b094f3098
                            Title: Example title
